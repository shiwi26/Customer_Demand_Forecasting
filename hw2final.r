...
for2 = as.formula(Casual~Index+year+as.factor(month)+as.factor(day)+as.factor(season)+as.factor(holiday)+as.factor(workingday)+meanatemp+maxatemp+minatemp+sdatemp+meanhumidity+maxhumidity+minhumidity+sdhumidity+meanwindspeed+maxwindspeed+minwindspeed+sdwindspeed);
for3 = as.formula(Registered~Index+year+as.factor(month)+as.factor(day)+as.factor(season)+as.factor(holiday)+as.factor(workingday)+meanatemp+maxatemp+minatemp+sdatemp+meanhumidity+maxhumidity+minhumidity+sdhumidity+meanwindspeed+maxwindspeed+minwindspeed+sdwindspeed);
